...
class MetadataModelResponse(UniversalBaseModel):
    name: str
    versions: typing.Optional[typing.List[str]] = None
    platform: str
    inputs: typing.Optional[typing.List[MetadataTensor]] = None
    outputs: typing.Optional[typing.List[MetadataTensor]] = None
